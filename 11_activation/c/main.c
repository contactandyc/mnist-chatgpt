...
int main(int argc, char *argv[]) {
    ...
    float learning_rate = 0.0001; // TODO: Adjust as needed
    int epochs = 500; // TODO: Adjust as needed
    ...
    Dataset test_dataset = {
        .num_samples = test_data.num_inputs / 10,
        .input_size = 784,
        .output_size = 10,
    ...
    // addDenseLayer(network, 128, sigmoid, sigmoidDerivative, randomInitialization);
    // addDenseLayer(network, 128, sigmoid, sigmoidDerivative, xavierInitialization);
    addDenseLayer(network, 128, relu, reluDerivative, heInitialization);
    addDenseLayer(network, 10, softmax, softmaxDerivative, xavierInitialization); // If you're classifying digits, the output layer size should be 10.
